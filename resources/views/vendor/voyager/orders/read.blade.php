        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel panel-bordered" style="padding-bottom:5px;">
                    ...
                    <div class="panel-heading" style="border-bottom:0; margin-bottom: 20px;">
                        <h3 class="panel-title bg-info">Products For This Order</h3>
                    </div>
                                ...
                                @foreach ($products as $product)
                                    <div class="col-sm-4" style="margin-bottom: 10px;">
                                        ...
                                        <div class="float-right">
                                            <img src="{{ productImage($product->image) }}" alt="" class="img-responsive">
                                        </div>
                                    </div>
                                @endforeach
