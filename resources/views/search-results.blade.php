    ...
    <section id="item" class="py-2 mb-4">
        <div class="container">
            <div class="row">
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                @foreach ($products as $product)
                                    <tr>
                                        <td scope="" class=""><a class="text-dark" href="{{ route('shop.show',$product->slug) }}">{!! $product->name !!}</a></td>
                                        <td>{!! str_limit($product->details, 40) !!}</td>
                ...
                <div class="col-sm-12 text-center d-flex justify-content-end mt-3">
