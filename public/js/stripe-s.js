! function (e) {
    ...
    var ce, le, pe, fe, de, he = function (e) {
            function t(e) {
                r(this, t);
        ...
        we = function (e) {
            return ge(e) ? Array.isArray(e) ? e.slice(0, e.length) : _e({}, e) : e
        },
        Ee = function e(t) {
            return function () {
                ...
                return r.forEach(function (n) {
                    n && Object.keys(n).forEach(function (r) {
                        ...
                        "object" === (void 0 === a ? "undefined" : me(a)) && s ? i[r] = e(t)(o, we(a)) : void 0 !== a ? i[r] = ge(a) ? e(t)(a) : we(a) : void 0 !== o && (i[r] = o)
                    })
                }), i
            }
        },
        ...
        Le = function (e, t) {
            return function (n, r) {
                var o = e(n, r),
                    i = t(n, r);
                return "error" === o.type && "error" === i.type ? "mismatch" === o.errorType ? "mismatch" === i.errorType ? qe(o.expected + " or " + i.expected, n, r) : Me(i.error) : Me(o.error) : "valid" === o.type ? o : i
            }
        },
        xe = function (e, t) {
            return function (n, r) {
        ...
        Ve = function (e, t) {
            return "number" == typeof e && e === parseInt(e, 10) ? Ie(e) : qe("an amount in the currency's subunit", e, t)
        },
        Ye = function (e, t) {
            return e && "object" === (void 0 === e ? "undefined" : je(e)) ? Ie(e) : qe("an object", e, t)
        },
        Ge = function (e) {
            return function (t, n) {
                if (Array.isArray(t)) {
                    return t.map(function (t, r) {
                        ...
                        return "error" === e.type ? e : "error" === t.type ? t : Ie([].concat(s(e.value), [t.value]), [].concat(s(e.warnings), s(t.warnings)))
                    }, Ie([]))
                }
                return qe("array", t, n)
            }
                        ...
                        if ("valid" === o.type)
                            for (var i = {}, a = 0; a < o.value.length; a += 1) {
                                ...
                                if ("object" === (void 0 === s ? "undefined" : je(s)) && s && "string" == typeof s[e]) {
                                    var u = s[e];
                                    if (i[u]) return Me(new ye("Duplicate value for " + e + ": " + u + ". The property '" + e + "' of '" + r.path.join(".") + "' has to be unique."));
                                    i[u] = !0
                                }
                            }
                        return o
        ...
        We = function (e) {
            return function (t, n) {
                return void 0 === t ? Ie(void 0) : qe("used in " + e + " instead", t, n)
            }
        },
        $e = function (e) {
            return function (t) {
                return function (n, r) {
                    if (n && "object" === (void 0 === n ? "undefined" : je(n)) && !Array.isArray(n)) {
                        ...
                        if (i && e) return Me(new ye("Invalid " + r.label + " parameter: " + [].concat(s(r.path), [i]).join(".") + " is not an accepted parameter."));
                        var u = Ie({});
                        return i && (u = Object.keys(o).reduce(function (e, n) {
                            return t[n] ? e : Ie(e.value, [].concat(s(e.warnings), ["Unrecognized " + r.label + " parameter: " + [].concat(s(r.path), [n]).join(".") + " is not a recognized parameter. This may cause issues with your integration in the future."]))
                            ...
                            return "valid" === u.type && void 0 !== u.value ? Ie(Te({}, e.value, a({}, n, u.value)), [].concat(s(e.warnings), s(u.warnings))) : "valid" === u.type ? Ie(e.value, [].concat(s(e.warnings), s(u.warnings))) : u
                        }, u)
                    }
        ...
        Xe = function (e, t, n, r) {
            ...
            if ("valid" === i.type) return {
                value: i.value,
                warnings: i.warnings
            };
            throw "full" === i.errorType ? i.error : new ye(Re(i.expected, i.actual, i.options))
        },
        et = function (e) {
        ...
        lt = function (e) {
            switch (e) {
                case "CARD_ELEMENT":
                    return ct("elements-inner-card-41fa34d12d20ee4f6aa499b31e936db3.html");
                case "CONTROLLER":
                    return ct("controller-cd5c99592cbe11c84ff34f446cdc1f9d.html");
                case "METRICS_CONTROLLER":
                    return "https://js.stripe.com/v2/m/outer.html";
                case "PAYMENT_REQUEST_ELEMENT":
                    return ct("elements-inner-payment-request-779773e8abac98257c615f2aa8559d89.html");
                case "PAYMENT_REQUEST":
                    return ct("payment-request-inner-8f7d01c545e7161fc115d5e09531fb1c.html");
                case "SEPA_IBAN_ELEMENT":
                    return ct("elements-inner-sepa-iban-06d11452ea1a7e0621612ab524b6e4e7.html");
                case "IDEAL_BANK_ELEMENT":
                    return ct("elements-inner-ideal-bank-e2beb5b264d29053c8e93d0b8109d629.html");
                case "THREE_DS":
                    return ct("three-ds-inner-4a8e0291fb6f427592c4fedade929a92.html");
                default:
                    return ut(e)
            }
        },
        ...
        Lt = function (e) {
            var t = e.frameId,
                ...
                o = yt,
                i = void 0;
            "controller" === r ? i = qt(t) : "group" === r ? i = qt(n) : "outer" === r ? i = window.frames[t] : "inner" === r && (o = "*", i = window.parent), i && i.postMessage(JSON.stringify(Nt({}, e, {
                __stripeJsV3: !0
            })), o)
        },
        xt = function (e) {
        ...
        zt = function e() {
            ...
            c(this, e), this._emit = function (e) {
                ...
                if ("string" != typeof e) throw new ye("When adding an event listener, the first argument should be a string event name.");
                if ("function" != typeof n) throw new ye("When adding an event listener, the second argument should be a function callback.");
        ...
        Gt = function (e) {
            ...
            return d(t, e), Yt(t, [{
                ...
                value: function (e) {
                    ...
                    this._persistentMessages = [].concat(l(this._persistentMessages), [t]), this.loaded && Lt(t)
                }
            }, {
                key: "action",
                value: function (e) {
                    ...
                    return this._requests[r] = Vt({}, this._requests[r], {
                        promise: o
                    }), o
                }
            }, {
                ...
                key: "_send",
                value: function (e) {
                    this._ensureMounted(), this.loaded ? Lt(e) : this._queuedMessages = [].concat(l(this._queuedMessages), [e])
                }
            }, {
                key: "appendTo",
                value: function (e) {
                ...
                value: function (e) {
                    var t = window.location.href.toString(),
                        n = tt(t),
                        r = n ? n.origin : "",
                        o = e.queryString && "string" == typeof e.queryString ? e.queryString : St(Vt({}, e, {
                            origin: r,
                            referrer: t,
                            controllerId: this._controllerId
                        })),
                        i = document.createElement("iframe");
                    return i.setAttribute("frameborder", "0"), i.setAttribute("allowTransparency", "true"), i.setAttribute("scrolling", "no"), i.setAttribute("name", this.id), i.setAttribute("allowpaymentrequest", "true"), i.src = pt(this.type) + "#" + o, i
                }
            }]), t
        }(Kt),
        Jt = Gt,
        ...
        Qt = function (e) {
            ...
            return _(t, e), Wt(t, [{
                key: "_ensureMounted",
                value: function () {
                    $t(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), "_ensureMounted", this).call(this), this._isMounted() || this._autoMount()
                }
            }, {
                key: "_autoMount",
                value: function () {
                    if (document.body) this.appendTo(document.body);
                    else if ("complete" === document.readyState || "interactive" === document.readyState) throw new ye("Stripe.js requires that your page has a <body> element.");
                ...
                value: function (e) {
                    ...
                    return n.setAttribute("aria-hidden", "true"), n.setAttribute("allowpaymentrequest", "true"), n.setAttribute("tabIndex", "-1"), Mt(n, Zt), n
                }
            }]), t
        }(Jt),
        Xt = Qt,
        ...
        tn = function (e) {
            function t() {
                return m(this, t), v(this, (t.__proto__ || Object.getPrototypeOf(t)).apply(this, arguments))
            }
            return b(t, e), en(t, [{
                key: "_generateId",
                value: function () {
        ...
        sn = function (e) {
            ...
            return E(t, e), rn(t, [{
                ...
                value: function (e) {
                    ...
                    return n.setAttribute("title", "Secure payment input frame"), Mt(n, an), n
                }
            }]), t
        }(Jt),
        un = sn,
        ...
        hn = function (e) {
            ...
            return k(t, e), cn(t, [{
                key: "_createIFrame",
                value: function (e) {
                    var n = ln(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), "_createIFrame", this).call(this, e);
                    return Mt(n, fn), n
                }
            }]), t
        }(Jt),
        ...
        gn = function (e) {
            ...
            return C(t, e), mn(t, [{
                ...
                key: "_createIFrame",
                value: function (e) {
                    var n = vn(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), "_createIFrame", this).call(this, _n({}, e, {
                        isSecondaryFrame: !0
                    }));
                    return Mt(n, bn), n.style.height = "0", n
                }
            }]), t
        }(Jt),
        wn = gn,
        ...
        Sn = function (e) {
            return On(e, "https://js.stripe.com/v3/")
        },
        kn = function (e) {
            return Sn(e) || En(e)
        },
        Pn = ["button", "checkbox", "file", "hidden", "image", "submit", "radio", "reset"],
        An = function (e) {
            var t = e.tagName;
            if (e.isContentEditable || "TEXTAREA" === t) return !0;
            if ("INPUT" !== t) return !1;
            var n = e.getAttribute("type");
            return -1 === Pn.indexOf(n)
        },
        Cn = An,
        Tn = function (e) {
        ...
        Rn = function (e) {
            return /iPad|iPhone/i.test(e) && !Tn(e)
        },
        In = function (e) {
            return /Android/.test(e) && !Tn(e)
        },
        Mn = window.navigator.userAgent,
        qn = (function (e) {
            /Edge\//i.test(e)
        }(Mn), Tn(Mn), function (e) {
            /MSIE 9/i.test(e)
        ...
        Nn = (function (e) {
            ...
            /^((?!chrome|android).)*safari/i.test(e) && jn(e)
        }(Mn), function (e) {
            /Firefox\//i.test(e)
        }(Mn), jn(Mn)),
        Ln = (window.ApplePaySession, ce = {}, T(ce, dt.card, {
            unique: !0,
        ...
        xn = Ln,
        Fn = (le = {}, j(le, dt.card, st.CARD_ELEMENT), j(le, dt.cardNumber, st.CARD_ELEMENT), j(le, dt.cardExpiry, st.CARD_ELEMENT), j(le, dt.cardCvc, st.CARD_ELEMENT), j(le, dt.postalCode, st.CARD_ELEMENT), j(le, dt.paymentRequestButton, st.PAYMENT_REQUEST_ELEMENT), j(le, dt.sepaIban, st.SEPA_IBAN_ELEMENT), j(le, dt.idealBank, st.IDEAL_BANK_ELEMENT), le),
        Bn = Fn,
        Dn = ["brand"],
        Un = ["country", "bankName"],
        Hn = (pe = {}, R(pe, dt.card, Dn), R(pe, dt.cardNumber, Dn), R(pe, dt.sepaIban, Un), pe),
        zn = R({}, dt.idealBank, {
            secondary: dt.idealSecondary
        }),
        ...
        Yn = function e(t) {
            ...
            var n = t.apiKey,
                ...
                o = t.stripeJsId,
                i = t.features;
            this._id = gt("__privateStripeController"), this._stripeJsId = o, this._apiKey = n, this._stripeAccount = r, this._features = i || {}, this._controllerFrame = new nn(st.CONTROLLER, this._id, t), this._frames = {}, this._requests = {}, this._setupPostMessage(), this._handleMessage = Bt(this._handleMessage, this)
        },
        Gn = function () {
            var e = this;
            this.action = function (t, n) {
                ...
                return e._requests[r] = Kn({}, e._requests[r], {
                    promise: o
                }), o
            }, this.createElementFrame = function (t, n) {
                var r = n.groupId,
                    o = I(n, ["groupId"]),
                    i = new un(t, e._id, Kn({}, o, {
                ...
                if (n === e._id) switch (o.action) {
                        ...
                        if (i) {
                            if (qn) {
                                var c = i._iframe.parentElement,
                                    ...
                                    p = document.activeElement === i._iframe || c && document.activeElement === l;
                                if ("focus" === s && !Vn && !p) {
                                    l && l.focus(), Vn = !0;
                                    break
                                }
                    ...
                    case "stripe-user-action-error":
                        e._requests[o.payload.nonce] && e._requests[o.payload.nonce].reject(new ye(o.payload.error))
                }
            }
        },
        Jn = Yn,
        ...
        er = function e(t) {
            return new Ct(function (n, r) {
                var o = t.method,
                    ...
                    u = t.withCredentials,
                    c = s ? St(s) : "",
                    l = !window.XMLHttpRequest || nt(i) && void 0 === (new XMLHttpRequest).withCredentials,
                    p = "GET" === o && c ? i + "?" + c : i,
                    f = "GET" === o ? "" : c;
                if (l) {
                    ...
                    a && (y = setTimeout(function () {
                        return h.abort()
                    }, a)), u && (h.withCredentials = u), h.open(o, p, !0), Xn(h), h.onreadystatechange = function () {
                        4 === h.readyState && (clearTimeout(y), h.onreadystatechange = function () {}, 0 === h.status ? u ? r(new $n) : e(Zn({}, t, {
                            withCredentials: !0
                        })).then(n, r) : n(h))
                    };
                    try {
        ...
        ir = function (e, t) {
            var n = e.replace(/\/\*.*\*\//g, "").trim(),
                ...
                o = r.match(/((([^;(]*\([^()]*\)[^;)]*)|[^;]+)+)(?=;)/g);
            if (!o) throw new ye("Found @font-face rule containing no valid font-properties in file from " + t);
            return o
        },
        ar = function (e, t) {
            var n = e.indexOf(":");
            if (-1 === n) throw new ye("Invalid css declaration in file from " + t + ': "' + e + '"');
            var r = e.slice(0, n).trim(),
                o = mt[r];
            if (!o) throw new ye("Unsupported css property in file from " + t + ': "' + r + '"');
            return {
                property: o,
        ...
        sr = function (e, t) {
            ...
            return ["family", "src"].forEach(function (e) {
                if (!n[e]) throw new ye("Missing css property in file from " + t + ': "' + _t[e] + '"')
            }), n
        },
        ur = function (e) {
            return tr({
        ...
        cr = ur,
        lr = function (e, t) {
            if (!(e && e in xn)) throw new ye("A valid Element name must be provided. Valid Elements are:\n" + Object.keys(xn).filter(function (e) {
                return !xn[e].beta
            }).join(", ") + "; you passed: " + e + ".");
            if (xn[e].unique && -1 !== t.indexOf(e)) throw new ye("Can only create one Element of type " + e + ".");
            var n = Se(t, xn[e].conflict);
            if (n.length) {
                var r = n[0];
                throw new ye("Cannot create an Element of type " + e + " after an Element of type " + r + " has already been created.")
            }
        },
        pr = function (e, t) {
        ...
        yr = function () {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "1.2em",
                t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : dr,
        ...
        Or = function (e) {
            ...
            return window.ApplePaySession.canMakePaymentsWithActiveCard(e).then(function (e) {
                return Er && Er("payreq.can_make_payment_native_response", {
                    available: e
                }), e
            })
        }),
        Sr = function (e, t, n, r) {
            if (Er = r, window.ApplePaySession) {
                if (wr()) {
                    if (n && "https:" !== window.location.protocol) return window.console && window.console.warn("To test Apple Pay, you must serve this page over HTTPS."), Ct.resolve(!1);
                    ...
                    return n && window.console && window.console.warn("This version of Safari does not support ApplePay JS version 2."), Ct.resolve(!1)
                }
                return Ct.resolve(!1)
            }
            return Ct.resolve(!1)
        ...
        kr = null,
        Pr = function (e, t) {
            return null !== kr ? Ct.resolve(kr) : br ? Nn ? Ct.resolve(!1) : t && "https:" !== window.location.protocol ? (window.console && window.console.warn("To test Payment Request, you must serve this page over HTTPS."), Ct.resolve(!1)) : e ? e.action(gr.CAN_MAKE_PAYMENT).then(function (e) {
                var t = e.available;
                return kr = "boolean" == typeof t && t
            }) : Ct.resolve(!1) : Ct.resolve(!1)
        },
        ...
        Lr = Ar({}, Rr, {
            status: Fe.apply(void 0, F(Object.keys(Nr)))
        }),
        xr = Ar({}, Rr, {
            currency: Ne(Ue)
        }),
        ...
        Dr = Qe(qr),
        Ur = ["mastercard", "visa"],
        Hr = ["AT", "AU", "BE", "CA", "CH", "DE", "DK", "ES", "FI", "FR", "GB", "HK", "IE", "IT", "JP", "LU", "NL", "NO", "NZ", "PT", "SE", "SG", "US"],
        zr = function (e, t) {
        ...
        Zr = (fe = {}, D(fe, Nr.success, 0), D(fe, Nr.fail, 1), D(fe, Nr.invalid_payer_name, 2), D(fe, Nr.invalid_shipping_address, 3), D(fe, Nr.invalid_payer_phone, 4), D(fe, Nr.invalid_payer_email, 4), fe),
        Qr = (de = {}, D(de, Ir.pickup, "storePickup"), D(de, Ir.shipping, "shipping"), D(de, Ir.delivery, "delivery"), de),
        Xr = {
            total: function (e) {
                return Jr(e.total, e)
            },
        ...
        no = (Gr({}, to, eo), function (e) {
            var t = {},
                n = Gr({}, Cr, e);
            return Object.keys(eo).forEach(function (e) {
                var r = eo[e],
                    o = r(n);
                null !== o && (t[e] = o)
            }), t
        ...
        ro = function (e) {
            var t = {};
            return Object.keys(to).forEach(function (n) {
                var r = to[n],
                    o = r(e);
                null !== o && (t[n] = o)
            }), t
        ...
        mo = function (e) {
            return /^pk_test_/.test(e) ? _o.test : /^pk_live_/.test(e) ? _o.live : _o.unknown
        },
        vo = function (e) {
            if (e === _o.unknown) throw new ye("It looks like you're using an older Stripe key. In order to use this API, you'll need to use a modern API key, which is prefixed with 'pk_live_' or 'pk_test_'.\n    You can roll your publishable key here: https://dashboard.stripe.com/account/apikeys")
        },
        bo = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
            return typeof e
        } : function (e) {
            return e && "function" == typeof Symbol && e.constructor === Symbol && e !== Symbol.prototype ? "symbol" : typeof e
        },
        ...
        Oo = function (e) {
            function t(e, n, r) {
                ...
                So.call(o), o._showCalledByButtonElement = null, o._authentication = n, o._controller = e, o._report("payreq.options", {
                    options: r
                });
            ...
            return V(t, e), wo(t, [{
                ...
                value: function () {
                    this._paymentRequestOptions = go({}, this._initialPaymentRequest, {
                        status: Nr.success
                ...
                value: function (e) {
                    var t = this;
                    e.addEventListener("validatemerchant", Bt(this._validateMerchant(e))), e.addEventListener("paymentauthorized", Bt(this._paymentAuthorized(e))), e.addEventListener("cancel", Bt(function () {
                        t._report("payreq.show_rejected"), t._isShowing = !1, t._emit("cancel")
                    })), e.addEventListener("shippingcontactselected", Bt(this._shippingContactSelected(e))), e.addEventListener("shippingmethodselected", Bt(this._shippingMethodSelected(e)))
                }
            }]), t
        }(Kt),
        So = function () {
            ...
            this.canMakePayment = Bt(function () {
                return null === e._cachedCanMakePayment ? Sr(window.location.hostname, e._authentication.stripeAccount, mo(e._authentication.apiKey) === _o.test, e._report).then(function (t) {
                ...
                if (e._isShowing) throw new ye("You cannot update Payment Request options while the payment sheet is showing.");
                var n = Xe(Br, t, "PaymentRequest update()"),
                    r = n.value;
                n.warnings.forEach(function (t) {
                    return e._controller.warn(t)
                }), e._initialPaymentRequest = Oe(e._paymentRequestOptions, r), e._initializeSessionState(), e._report("payreq.update", {
                    updates: t
                })
                ...
                if (!e._cachedCanMakePayment) throw new ye("Payment Request is not available in this browser.");
                e._initializeSessionState();
                var t = new window.ApplePaySession(2, oo(e._paymentRequestOptions));
                e._privateSession = t, e._setupSession(t), t.begin(), e._isShowing = !0, e._report("payreq.show", {
                ...
                e._controller.report(t, go({}, n, null !== e._showCalledByButtonElement ? {
                ...
                return function (n) {
                    e._controller.action(it.CREATE_APPLE_PAY_SESSION, {
                        data: {
                ...
                return function (n) {
                    var r = n.message;
                    t.abort(), "string" == typeof r ? (e._controller.warn(n.message), e._report("user_error.apple_pay_session_error", {
                        error: n
                ...
                return function (n) {
                    var r = n.payment;
                    e._report("payreq.paymentauthorized"), e._controller.action(it.TOKENIZE, go({}, r, {
                        billingContact: e._normalizeContact(r.billingContact),
                        type: "apple_pay",
                        elementName: e._showCalledByButtonElement ? dt.paymentRequestButton : void 0
                    })).then(function (n) {
                        var o = n.token,
                            i = n.error;
                        if (i) t.completePayment(window.ApplePaySession.STATUS_FAILURE), e._report("fatal.payreq.on_error", {
                            error: i
                        });
                        else {
                ...
                if (t && "object" === (void 0 === t ? "undefined" : bo(t)) && t.country && "string" == typeof t.country) {
                    var n = t.country.toLowerCase().replace(/[^a-z]+/g, ""),
                        r = void 0;
                    return t.countryCode ? "string" == typeof t.countryCode && (r = t.countryCode.toUpperCase()) : (r = Eo[n]) || e._report("fatal.payreq.missing_country_code", {
                        country: t.country
                    }), go({}, t, {
                        countryCode: r
                    })
                ...
                return function (n) {
                    if (e._hasRegisteredListener("token") && e._emit("token", go({}, n, {
                        ...
                        e._controller.action(it.CREATE_SOURCE, {
                            ...
                            a ? (e._report("fatal.payreq.source_failed", {
                                error: a,
                                token: r
                            }), t.completePayment(window.ApplePaySession.STATUS_FAILURE)) : e._emit("source", go({}, o, {
                                source: i,
                                complete: e._completePayment(t)
                            }))
                        })
                ...
                return function (n) {
                    ...
                    if (r.warnings.forEach(function (t) {
                            return e._controller.warn(t)
                        }), e._paymentRequestOptions = Oe(e._paymentRequestOptions, o), e._paymentRequestOptions.status === Nr.success) {
                ...
                return function (n) {
                    if (e._privateShippingOption = fo({
        ...
        Ao = function (e) {
            function t(e, n, r) {
                ...
                Co.call(o), o._showCalledByButtonElement = null, o._authentication = n, o._controller = e, o._report("payreq.options", {
                    options: r
                ...
                if (i.warnings.forEach(function (e) {
                    ...
                    o._controller.action(it.FETCH_LOCALE, {
                        locale: "auto"
                    });
        ...
        Co = function () {
            var e = this;
            this.canMakePayment = Bt(function () {
                return null === e._cachedCanMakePayment ? Pr(e._prFrame, mo(e._authentication.apiKey) === _o.test).then(function (t) {
                    return e._canMakePaymentCalled = !0, e._cachedCanMakePayment = t, e._report("payreq.can_make_payment_response", {
                        available: e._cachedCanMakePayment
                    }), e._cachedCanMakePayment ? {
                        applePay: !1
                ...
                if (null === e._showCalledByButtonElement && (e._showCalledByButtonElement = !1), e._usedByButtonElement && !e._showCalledByButtonElement && (e._report("payreq.show_called_with_button"), e._controller.warn("Do not call show() yourself if you are using the paymentRequestButton Element.\nThe Element handles showing the payment sheet.")), !e._canMakePaymentCalled) throw new ye("You must first check the Payment Request API's\navailability using paymentRequest.canMakePayment() before calling show().");
                if (!e._cachedCanMakePayment || !e._prFrame) throw new ye("Payment Request is not available in this browser.");
                e._prFrame.send({
                ...
                e._controller.report(t, Po({}, n, null !== e._showCalledByButtonElement ? {
                    usesButtonElement: e._showCalledByButtonElement
                } : {}, {
                    impl: "prapi"
                }))
                ...
                t.send({
                    ...
                    if ("token" === o) {
                            ...
                            e._emit(o, Po({}, l, {
                                updateWith: function (r) {
                                    ...
                                    a.warnings.forEach(function (t) {
                                        return e._controller.warn(t)
                                    }), "shippingaddresschange" === o && s.status === Nr.success && yo(s.shippingOptions || n.shippingOptions), t.send({
                                        action: "stripe-pr-callback-complete",
                                        payload: {
                                            nonce: i,
                                            data: s
                        ...
                        } else "shippingaddresschange" === o && yo(n.shippingOptions), t.send({
                            action: "stripe-pr-callback-complete",
                            payload: {
                                nonce: i,
                                data: {
                ...
                var o = n._privateOwner,
                    i = Y(n, ["_privateOwner"]);
                if (e._hasRegisteredListener("token") && e._emit("token", Po({}, i, {
                        complete: r
                    })), e._hasRegisteredListener("source")) {
                    var a = i.token,
                        s = Y(i, ["token"]),
        ...
        To = Ao,
        jo = window.ApplePaySession ? function (e) {
            function t() {
                return $(this, t), Z(this, (t.__proto__ || Object.getPrototypeOf(t)).apply(this, arguments))
            }
            return Q(t, e), t
        }(ko) : function (e) {
            function t() {
        ...
        No = {
            ...
            paymentRequest: Ne(function (e, t) {
                return function (n, r) {
        ...
        Ho = function (e) {
            function t(e) {
                ...
                if (a) {
                    if (!i) throw new ye("You must pass in a stripe.paymentRequest object in order to use this Element.");
                    n._paymentRequest = i, n._paymentRequest._registerElement()
                }
                return n._createComponent(e, o), n._classes = Io({}, xo), n._changeClasses(e.classes || {}), n._lastBackgroundColor = "", n._destroyed = !1, n._focused = !1, n._empty = !a, n._invalid = !1, n._complete = !1, n._autofilled = !1, n._lastSubmittedAt = null, n
            }
            return re(t, e), Mo(t, [{
                key: "_checkDestroyed",
                value: function () {
                    if (this._destroyed) throw new ye("This Element has already been destroyed. Please create a new one.")
                }
            }, {
                key: "_isMounted",
                value: function () {
                ...
                value: function (e) {
                    ...
                    if (e === t) {
                        ...
                        if (n) throw new ye("This Element is already mounted. Use `unmount()` to unmount the Element before re-mounting.");
                        this.unmount(), this._mountTo(e)
                ...
                value: function (e) {
                    ...
                    return Object.keys(e).forEach(function (n) {
                        if (!xo[n]) throw new ye(n + " is not a customizable class name.\nYou can customize: " + Object.keys(xo).join(", "));
                        var r = e[n] || xo[n];
                        t[n] = r.replace(/\./g, " ")
                    }), this._classes = Io({}, this._classes, t), this
                }
            }, {
                key: "_emitEvent",
                value: function (e, t) {
                    return this._emit(e, Io({
                ...
                value: function () {
                    ...
                    this._frame._on("redirectfocus", function (t) {
                        ...
                        var n = {};
                        ["error", "value", "empty", "complete"].concat(ee(Hn[e._componentName] || [])).forEach(function (e) {
                            return n[e] = t[e]
                        ...
                        if (e._parent) {
                            ...
                            if (n) {
                                ...
                                0 !== r && Do(r) < Do(o) && e._controller.report("wrapper_height_mismatch", {
                                    height: o,
                                    outer_height: r
                                });
                                var s = e._component.getBoundingClientRect().height;
                                0 !== s && 0 !== o && Do(s) !== Do(o) && (e._frame.updateStyle({
                                    height: o + "px"
                ...
                value: function (e, t, n) {
                    var r = this._controller.createSecondaryElementFrame(e, Io({}, n, {
                        componentName: t
                    }));
                ...
                value: function (e) {
                    ...
                    if ("paymentRequestButton" === this._componentName) {
                        ...
                        if (l && !Uo(l) && this._controller.warn("The fontSize style you specified (" + l + ") is not in px. We do not recommend using relative css units, as they will be calculated relative to our iframe's styles rather than your site's."), t || c || l) {
                            var f = -1 === vt.indexOf(this._componentName) ? void 0 : p || this._lastPadding,
                ...
                value: function (e, t) {
                    ...
                    a.className = "__PrivateStripeElement-safariInput", a.setAttribute("aria-hidden", "true"), a.setAttribute("tabindex", "-1"), Mt(o, Fo), Mt(i, Bo), Mt(a, Bo);
                    ...
                    if (p._on("load", function () {
                        ...
                        this._secondaryFrame = this._createSecondFrame(c, f, l), this._secondaryFrame.appendTo(o), window.addEventListener("click", function () {
        ...
        zo = function () {
            ...
            this.mount = Bt(function (t) {
                e._checkDestroyed();
                var n = void 0;
                if (!t) throw new ye("Missing argument. Make sure to call mount() with a valid DOM element or selector.");
                if ("string" == typeof t) {
                    ...
                    if (!t.appendChild) throw new ye("Invalid DOM element. Make sure to call mount() with a valid DOM element or selector.");
                    n = t
                }
                if ("INPUT" === n.nodeName) throw new ye("Stripe Elements must be mounted in a DOM element that\ncan contain child nodes. `input` elements are not permitted to have child\nnodes. Try using a `div` element instead.");
                if (n.children.length && e._controller.warn("This Element will be mounted to a DOM element that contains child nodes."), e._paymentRequest) {
                    if (!e._paymentRequest._canMakePaymentCalled) throw new ye("For paymentRequest Elements, you must first check the Payment Request API's\navailability using paymentRequest.canMakePayment() before mounting the Element.");
                    if (!e._paymentRequest._cachedCanMakePayment) throw new ye("The " + e._componentName + " Element is not available in the current environment.");
                    e._mountToParent(n)
        ...
        Jo = function e(t, n) {
            ...
            o.warnings.forEach(function (e) {
                ...
                options: n
            }), this._elements = [], this._id = gt("elements"), this._controller = t;
            var a = i.locale,
                s = i.fonts || [];
            this._controller.action(it.FETCH_LOCALE, {
                locale: a || "auto"
            });
            ...
            return this._pendingFonts = c.length, this._commonOptions = Vo({}, i, {
                fonts: u
            }), c.forEach(function (e) {
                if ("string" == typeof e) {
                    var t = Date.now();
                    cr(e).then(function (n) {
        ...
        Wo = function () {
            ...
            this.create = Dt(function (t, n) {
                ...
                var i = !!e._pendingFonts,
                    a = new Ko(Vo({}, o, e._commonOptions, {
                        controller: e._controller,
                        componentName: t,
                        groupId: e._id,
                        wait: i
                    }));
                return e._elements = [].concat(oe(e._elements), [t]), a._on("destroy", function () {
        ...
        Xo = (Ze(Qo), function (e, t, n, r) {
            return e ? (t.report("3ds.shown_twice"), Ct.resolve({
                error: {
                    code: "show_called_twice"
                }
            })) : (t.report("3ds.show"), n.show(), n.send({
                action: "stripe-3ds-show",
                payload: {
                    data: r
                }
            }), new Ct(function (e, t) {
        ...
        ei = function (e, t) {
            e.report("3ds.mount");
            var n = e.createLightboxFrame(st.THREE_DS, {
                    variation: t
                }),
                r = !1;
            return {
        ...
        ci = function () {
            function e() {
                ae(this, e), this._muid = this._getID(ui.MERCHANT), this._sid = this._getID(ui.SESSION), this._id = gt(si), this._controllerFrame = new nn(st.METRICS_CONTROLLER, this._id, {
                    autoload: !0,
            ...
            return ai(e, [{
                ...
                key: "send",
                value: function (e) {
                    var t = pt(st.METRICS_CONTROLLER);
                    Sn(t) && this._controllerFrame.send(e)
                }
            }, {
                key: "_testLatency",
                value: function () {
        ...
        mi = function (e) {
            var t = _i(),
                n = {},
                r = {};
            return Object.keys(di).forEach(function (o) {
                if (di[o]) {
                    var i = di[o],
                        a = i.likelihood,
                        s = i.whitelist,
        ...
        Oi = Qe({
            ...
            betas: Ne(Ge(Be.apply(void 0, function (e) {
                if (Array.isArray(e)) {
                    for (var t = 0, n = Array(e.length); t < e.length; t++) n[t] = e[t];
                    return n
                }
        ...
        Si = function () {
            function e(t, n) {
                ...
                var o = Xe(Oi, t || {}, "Stripe()"),
                    ...
                    l = i.betas;
                if ("" === s) throw new ye("Please call Stripe() with your publishable key. You used an empty string.");
                if (0 === s.indexOf("sk_")) throw new ye("You should not use your secret key with Stripe.js.\n        Please pass a publishable key instead.");
                this._apiKey = s, this._keyMode = mo(s);
                var p = this._initFeatures(c || {});
                this._betas = l || [], this._stripeAccount = u || null, this._controller = new Jn({
                    apiKey: s,
                    stripeAccount: u,
                ...
                }), this._ensureHTTPS(), this._ensureStripeHosted(n), this.retrievePaymentIntent = ri(this._betas, ti.payment_intent_beta_1, Bt(function (e) {
                    return vi(e, r._controller)
                })), this.fulfillPaymentIntent = ri(this._betas, ti.payment_intent_beta_1, Ut(function (e, t, n) {
            ...
            return Ei(e, [{
                ...
                value: function (e) {
                    if (!e) throw this._controller.report("user_error.self_hosted"), new ye("Stripe.js must be loaded from js.stripe.com. For more information https://stripe.com/docs/stripe-js/reference#including-stripejs")
                }
            }, {
                key: "_initFeatures",
                value: function (e) {
                    ...
                    return e && (Object.keys(e).forEach(function (e) {
                        di.hasOwnProperty(e) || console.error('Unrecognized feature "' + e + '" passed to "forcedFeatures".')
    ...
    var ki = function () {
            ...
            this.elements = Bt(function (t) {
                ...
                var r = "string" == typeof t ? t : void 0,
                    ...
                    a = n && "object" === (void 0 === n ? "undefined" : gi(n)) ? n : {},
                    s = wi({
                        type: r,
                        frameId: o,
                        elementName: i
                    }, a);
                return Si._ec && (s.mids = Si._ec.ids()), e._controller.action(it.TOKENIZE, s)
                ...
                var r = t && t._frame && t._frame.id ? t._frame.id : void 0,
                    ...
                    i = r ? n : t;
                if (!r && i && "object" !== (void 0 === i ? "undefined" : gi(i))) return Ct.reject(new ye("Please provide Source creation parameters to createSource."));
                var a = i && "object" === (void 0 === i ? "undefined" : gi(i)) ? i : {};
                return Si._ec && (a.mids = Si._ec.ids()), e._controller.action(it.CREATE_SOURCE, {
                    frameId: r,
                    data: a,
                    elementName: o
                })
            }), this.retrieveSource = Bt(function (t) {
                return e._controller.action(it.RETRIEVE_SOURCE, {
                    source: t
                })
            }), this.paymentRequest = Bt(function (t) {
                return vo(e._keyMode), new Ro(e._controller, {
                    apiKey: e._apiKey,
                ...
                return e._controller.action(it.AUTHORIZE_SOURCE, {
                    source: t
                }).then(function (t) {
                    var n = t.source,
                    ...
                    if ("redirect" === t.nextAction) {
                        var o = n.redirect;
                        return e._redirect(o.url), new Ct(function (t, n) {
                            setTimeout(function () {
        ...
        ji = function (e, t) {
            return new Pi(Ci({
                apiKey: e
            }, t && "object" === (void 0 === t ? "undefined" : Ai(t)) ? t : {}), Ti)
        };
    ji.version = Pi.version, window.addEventListener("load", function () {
        Pi._ec = new li
    }), window.Stripe && 2 === window.Stripe.version && !window.Stripe.StripeV3 ? window.Stripe.StripeV3 = ji : window.Stripe ? window.console && console.warn("It looks like Stripe.js was loaded more than one time. Please only load it once per page.") : window.Stripe = ji;
    t.default = ji
}, function (e, t, n) {
    "use strict";
